                ...
                children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          Icon(
                            ...
                            color: allAgreeChecked ? const Color(0xffF15A2B) : const Color(0xFF767676),
                            size: 24, // 아이콘 크기
                          ),
                        ...
                        children: [
                          Icon(
                            tosAgreeChecked
                                ? Icons.check_circle_sharp
                                : Icons.check_circle_outline_sharp,
                            color: tosAgreeChecked ? const Color(0xffF15A2B) : const Color(0xFF767676),
                            size: 24, // 아이콘 크기
                          ),
                          ...
                          IconButton(
                            onPressed: () {
                              final url = 'https://wsw0922.notion.site/1377011bfe4b80c2971ad813a817c6cd?pvs=4';
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                        ...
                        children: [
                          Icon(
                            marketingAgreeChecked
                              ? Icons.check_circle_sharp
                              : Icons.check_circle_outline_sharp,
                          color: marketingAgreeChecked ? const Color(0xffF15A2B) : const Color(0xFF767676),
                            size: 24,
                          ),
                          const SizedBox(width: 8),
                          const Text(
                          ...
                          IconButton(
                            onPressed: () {
                              final url = 'https://wsw0922.notion.site/1377011bfe4b804983fafe219fbdb1d1?pvs=4';
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => WebView(url: url),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        logger.d("tosAgreeChecked : $tosAgreeChecked, marketingAgreeChecked : $marketingAgreeChecked");
